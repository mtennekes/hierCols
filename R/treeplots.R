...
drawHCL <- function(gridsize=1e3, C=45, L=75, r=c(0.6, 0.8), cuts=NULL, marks=NULL, marks.dashed=FALSE, labels=NULL, marks.r=c(0.4, 0.8), labels.r=0.5, marks.labels.r=0.88, marks.labels.cex=0.8, labels.cex=0.8) {
    #grid.newpage()
    n <- gridsize
