...
Three visualisation methods were used in the survey, namely the (directed) graph, the treemap and the bar plot. For each of the three methods, respondents received questions of two plots, one with Tree Colors and one with 
...
\end{tabular}
\end{footnotesize}
\caption{Questionairre setup}\label{table:param}
\end{table}
