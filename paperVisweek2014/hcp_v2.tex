...
Color vision deficiency is caused by the disfunctioning of one of the three type of cone cells by which people normally perceive colors. The three type of cone cells correspond one to one to the perception of the three primary colors red, green, and blue. People with normal color vision, trichromats, perceive any color as a mixture of the three types of cone cells, whereas people with a non-functional type of cone cell, dichromats, use a mixture of the two remaining types of cone cells to perceive colors. People with a partly disfunctional type of cone cell are called anomalous trichromats. They require more light of the corresponding primary color wave length in order to perceive colors normally.

People with color vision deficiency cannot easily differentiate colors with different hue values. Especially distiction of colors in the red and green areas are often problematic for them. If this would be the only obstacle for them to use Tree Colors, a straightforward solution would be to adjust the Tree Colors method such these difficult hue ranges are omitted. However, there is a more fundamental problem for people with color vision deficiency. Since the adaption of colors by cone cells is approximately logarithmical rather than linear, a disfunctional type of cone cell will result in losing the perptual properties of the HCL color space. In other words, people with a color vision deficiency will not perceive colors with different hue values, and contant chroma and luminance values as equally bright. \martijn
