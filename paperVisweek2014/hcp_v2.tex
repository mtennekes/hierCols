...
The first problem that people with color vision deficiency have, is that they cannot easily differentiate colors with different hue values. Especially distiction in the red and green areas are often problematic for them. More importantly, 

<not only hue values are indistuiguishable...>

Since the adaption of colors by cone cells is approximately logarithmical rather then linear, a disfunctional type of cone cell will result in losing the perptual properties of the HCL color space. In other words, people with a color vision deficiency will not perceive colors with the different hue values, but contant chroma and luminance values as equally bright.
