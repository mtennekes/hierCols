...
\begin{figure}[htb]
  \centering
  \includegraphics[width=2.25in]{bar_chart.pdf}
  \caption{Bar chart with hierarchical colors}\label{fig:barchart}
\end{figure}
\begin{figure}[htb]
  \centering
  \includegraphics[width=2.25in]{stackedline_chart.pdf}
...
As an example of a non-hierarchically-structured plot, a bar chart and a stacked line chart are depicted in Figures~\ref{fig:barchart} and~\ref{fig:linechart} . Such graphics could be useful when the hierarchical structure will not be the main focus in the conducted analyses.
