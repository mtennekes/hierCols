...
We illustrate our method with the European classification system of economic activity NACE. (reference?). (iets zeggen over de grootte?) Section F (Construction) is depicted in Figure~\ref{fig:sbiF}. The nodes are colored with the resulting hierarchical color palette. 
